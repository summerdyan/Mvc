...
namespace Mvc.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(MvcMovieContext context)
        {
            _context = context;
        }
        ...
        {
            var mvcMovieContext = _context.Departments.Include(d => d.Administrator);
                ...
                s => s.Name, s => s.StartDate, s => s.Budget, s => s.InstructorID))
            {
                ...
                catch (DbUpdateConcurrencyException ex)
                {
                    ...
                    else
                    {
                        ...
                        departmentToUpdate.ConcurrencyToken = databaseValues.ConcurrencyToken;
